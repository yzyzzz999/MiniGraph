...
2. **明确标注**信息来源：
   ...
   - 来自常识补充：用"（补充）"标注
3. **禁止编造**知识图谱中没有的具体细节（如具体年份、精确数字等）
4. 可以补充常识，但必须明确标注，且不与图谱信息冲突
...
✓ 好的回答：
"唐朝是中国历史朝代（知识图谱，相关度0.70），与隋朝（相关度0.66）存在前后相继关系。唐朝是中国历史上强盛的朝代之一（补充），对后世影响深远。"

✗ 差的回答（编造细节）：
"唐朝是618年建立的，持续了289年..."（如果图谱中没有这些信息）
